...
import com.ulens.ulensapp.RegEx.ExactBill;
import com.ulens.ulensapp.RegEx.Price;
import com.ulens.ulensapp.SupportClasses.SingleUploadBroadcastReceiver;
...
public class InvoiceDetail extends AppCompatActivity implements SingleUploadBroadcastReceiver.Delegate{
    ...
    String sendInvoiceUrl="http://www.ulensapp.com/Api/Bill/PostInvoice";
    String addInvoicePhotoUrl = "http://ulensapp.com/Api/Bill/PostInvoicePhoto";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                          ...
                          //  Toast.makeText(getApplicationContext(),response,Toast.LENGTH_SHORT).show();
                            ...
                            if (json.getString("HasError").equals("false")){
                                uploadMultipart(getApplicationContext(),Id);
                            }
