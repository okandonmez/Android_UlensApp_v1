...
public class ReportedSendedInvoiceDetails extends AppCompatActivity {
    ...
    final String getReports = "http://ulensapp.com/api/Bill/GetReports?isVisible=true";
...
//
//
//                                if (jsonArray[0].getJSONObject(i).get("IsVisible").toString().equals("true")){
...
//                        }
        ...
        VolleyClass.getInstance(ReportedSendedInvoiceDetails.this).addToRequestQueue(stringRequest);
